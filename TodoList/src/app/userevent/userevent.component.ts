...
// }
getProducts(): any {
  this.service.getPending().subscribe((products) => {
    this.products1 = products.map(product=>({...product, showTextField:false,textField:'',showcheck:false,check:''}));
      
    
    this.dataSource.data = this.products1;
    this.service.total=this.products1.length;
    // this.service.progress=this.products1.length;
...
progress:number=this.service.progress;
